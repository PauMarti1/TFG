...
# plt.grid(True)
# plt.tight_layout()
# plt.savefig("/fhome/pmarti/TFGPau/RocCurves/ResNet_ROC_PerFold.png", dpi=300)
# plt.close()
...
np.savez("/fhome/pmarti/TFGPau/NPZs/ResNet.npz", 
    metrics=np.array(metrics, dtype=object),
    val_loss_per_fold=np.array(all_loss, dtype=object),
    roc_data_per_fold=np.array(roc_data_per_fold, dtype=object), allow_pickle=True)
...
# plt.grid(True)
# plt.tight_layout()
# plt.savefig("/fhome/pmarti/TFGPau/RocCurves/ResNet_ROC_Holdout.png", dpi=300)
# plt.close()
# # Resultats
# print(f'\nHoldout Results:')
